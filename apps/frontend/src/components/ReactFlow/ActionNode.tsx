...
import SelectActionEvent from "../SelectActions";
...
const ActionNode = ({ data }: NodeProps<Action>) => {
  ...
  return (
    <>
      ...
      <div className="w-[326px] p-2.5 border-black border border-secondary rounded-md bg-white text-black">
        <div className="flex flex-col gap-2">
          <div className="flex flex-col gap-2">
            ...
            {data.actionId && <SelectActionEvent />}
          </div>
        </div>
      </div>
